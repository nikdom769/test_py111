def calculate_paths(shape: (int, int), point: (int, int)) -> int:
	...
	"""
	for st in steps:
		if 0 <= s_point[0] + st[0] <= shape[0] and 0 <= [s_point[1] + st[1]]field[s_point[0] + st[0]][s_point[1] + st[1]] == 0 and :
			
			field[s_point[0] + st[0]][s_point[1] + st[1]] = field[s_point[0]][s_point[1]] * 2
